        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PLAN_NAME = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SOCIAL_SECURITY_NUMBER = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    ETHNICITY = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PERSONAL_BENEFIT_PLANS_BENEFIT_PLAN_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EMPLOYMENT_STATUS = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    HIRE_DATE_FOR_WORKING = table.Column<DateOnly>(type: "date", nullable: true),
                    WORKERS_COMP_CODE = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EMPLOYMENT_PERSONAL_PERSONAL_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EMPLOYMENT_WORKING_TIME_EMPLOYMENT_EMPLOYMENT_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JOB_HISTORY_EMPLOYMENT_EMPLOYMENT_ID",
                        column: x => x.EMPLOYMENT_ID,
                        principalTable: "EMPLOYMENT",
                        principalColumn: "EMPLOYMENT_ID");
                });
